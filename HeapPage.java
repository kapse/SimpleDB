...
public class HeapPage implements Page {
	...
	private int getNumTuples() {
		// some code goes here
		    int tupsPerPage = (int) (Math.floor(BufferPool.PAGE_SIZE*8) / (td.getSize() * 8 + 1)); //round down
	        return tupsPerPage;  
	...
	private int getHeaderSize() {
		...
		return (int) Math.ceil(tupsPerPage / 8);
	 ...
	 * @return 
	 */
	public Tuple addTuple(int curTuple) throws DbException {
		return null;
		// some code goes here
		// not necessary for assignment1
	}
	...
	class NewIterator implements Iterator<Tuple> {
	    int t = 0;
	    Tuple ret = null;
	    HeapPage p;

	    public NewIterator(HeapPage p) {
	        this.p = p;
	    }
	    public boolean hasNext() {										
	                   try {
						if(p.addTuple(t++) != null)
						   {return true; }
	                   } catch (DbException e) {
						e.printStackTrace();}
	                   return false;       
