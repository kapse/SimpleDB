...
public class TupleDesc {
	...
	public Type getType(int i) throws NoSuchElementException {
        ...
        throw new NoSuchElementException("No such type found for i");
	...
	public String toString() {
		...
		{
		description+=types[i]+"("+names[i]+")|";
		}
		description+=types[numFields()-1]+"("+names[numFields()-1]+")";
		return description;
	}
